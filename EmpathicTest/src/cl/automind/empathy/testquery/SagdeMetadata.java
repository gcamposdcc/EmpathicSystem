...
public class SagdeMetadata{
	...
	@Column(name="idsector") private int idSector;
	@Column(name="ideje") private int idAxis;
	@Column(name="idcmo") private int idCmo;
	@Column(name="idobjcon") private int idKo;
	@Column(name="idnivel") private int idLevel;
	@Column(name="idempathy") private int idEmpathy;
	...
	public void setIdEmpathy(int idEmpathy) {
		this.idEmpathy = idEmpathy;
	}
	public int getIdEmpathy() {
		return idEmpathy;
	}
